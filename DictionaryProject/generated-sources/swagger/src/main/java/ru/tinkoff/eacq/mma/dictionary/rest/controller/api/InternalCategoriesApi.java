...
import ru.tinkoff.eacq.mma.dictionary.rest.model.CategoriesCreateRequest;
import ru.tinkoff.eacq.mma.dictionary.rest.model.CategoriesResponse;
import ru.tinkoff.eacq.mma.dictionary.rest.model.CategoriesSocialPropertiesResponse;
import ru.tinkoff.eacq.mma.dictionary.rest.model.Error;
import ru.tinkoff.eacq.mma.dictionary.rest.model.Error409;
...
public interface InternalCategoriesApi {
    ...
    ResponseEntity<CategoriesSocialPropertiesResponse> internalApiV1SocialCategoriesCategoryCodeGet(@Pattern(regexp = "^[0-9]{4}$") @ApiParam(value = "код МСС", required = true) @PathVariable("categoryCode") String categoryCode);
