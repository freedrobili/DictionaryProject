...
public interface AdminsCategoriesApi {
    ...
    ResponseEntity<ShortCategories> _adminApiV1CategoriesProductNameGet(@ApiParam(value = "Продукт по которому необходимы МСС", required = true, allowableValues = "ecom, a2c, c2a, safeDeal") @PathVariable("productName") String productName);
